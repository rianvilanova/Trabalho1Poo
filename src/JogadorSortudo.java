...
public class JogadorSortudo extends Jogador {
    public JogadorSortudo(String nome, String cor, Scanner scanner) {
    ...
    public int lancarDados(Random random, boolean debug) {
        ...
        System.out.println(CoresConsole.GREEN + getCor() + " (Sortudo) lançou " + dado1 + " + " + dado2 + " = " + total + CoresConsole.RESET);
